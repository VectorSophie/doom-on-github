...
async function DoomModule(moduleArg = {}) {
  var moduleRtn;
...
function get_host_ticks_ms() { if (!self.startTime) self.startTime = performance.now(); return Math.floor(performance.now() - self.startTime); }

// Imports from the Wasm binary.
var _DG_GetFramebufferPtr,
  _DG_Github_FB_Read,
  _DG_Github_Init,
  _DG_Github_Input,
  _main,
  ...
  memory,
  _DG_Github_Framebuffer,
  __indirect_function_table,
  wasmMemory;


function assignWasmExports(wasmExports) {
  _DG_GetFramebufferPtr = Module['_DG_GetFramebufferPtr'] = wasmExports['DG_GetFramebufferPtr'];
  _DG_Github_FB_Read = Module['_DG_Github_FB_Read'] = wasmExports['DG_Github_FB_Read'];
  _DG_Github_Init = Module['_DG_Github_Init'] = wasmExports['DG_Github_Init'];
  _DG_Github_Input = Module['_DG_Github_Input'] = wasmExports['DG_Github_Input'];
  _main = Module['_main'] = wasmExports['__main_argc_argv'];
  _malloc = wasmExports['malloc'];
  _free = wasmExports['free'];
  _doomgeneric_Tick = Module['_doomgeneric_Tick'] = wasmExports['doomgeneric_Tick'];
  ...
  _DG_Github_Framebuffer = Module['_DG_Github_Framebuffer'] = wasmExports['DG_Github_Framebuffer'].value;
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = DoomModule;
